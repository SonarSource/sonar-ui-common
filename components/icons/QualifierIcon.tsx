...
function ApplicationIcon({ className, fill, size }: IconProps) {
  return (
...
function DeveloperIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
...
function DirectoryIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
...
function FileIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
...
function LibraryIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
...
function PortfolioIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
...
function ProjectIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
...
function SubPortfolioIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
...
function SubProjectIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
...
function UnitTestIcon({ className, fill, size }: IconProps) {
  return (
    <ThemedIcon className={className} size={size}>
      {({ theme }) => (
        <path
