...
export default {
  ...
  setNotificationsCenter(notificationsCenter: NotificationsCenter) {
    console.log('setNotificationsCenter', notificationsCenter);
...
export function getNotificationsCenter() {
  console.log('getNotificationsCenter', notificationsCenter);
